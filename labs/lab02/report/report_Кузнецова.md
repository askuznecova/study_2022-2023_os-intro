...
![Базовая настройка git](image/image1.png){#fig:001 width=70%}
...
![Создание ключа SSH](image/image2.png){ #fig:002 width=70% }



Ключ нужно добавить на github. Для этого переходим на сайте в раздел “Settings” и выбираем “SSH and GPG keys”.

![Ключ SSH создан](image/image3.png){ #fig:003 width=70% }

![Ключ GPG создан](image/image4.png){ #fig:004 width=70% }

Выводим список ключей и копируем отпечаток приватного ключа

![Отпечаток приватного ключа](image/image5.png){ #fig:005 width=70% }

Настройка автоматических подписей коммитов git

![Настройка подписей](image/image6.png){ #fig:006 width=70% }
...
![Настройка gh](image/image7.png)#fig:007 width=70% }
...
![Создание репозитория](image/image8.png){ #fig:008 width=70% }
...
![Настраиваем каталог курса](image/image9.png){ #fig:009 width=70% }
...
![Отправляем наши файлы на сервер](image/image10.png){ #fig:010 width=70% }
